                    ...
                    <div class="centralizar">
                        ...
                        <div id="all_info">
                            ...
                            <div class="linhabaixo">
                                ...
                                <button onclick="editproduto(<?=$produtos->produto_ID?>)"readonly>Editar</button>
                                </div>
                        </div>
                    </div>
                </div>
    ...
    <form enctype="multipart/form-data" action="../config/cadproduto.php" id="formaddproduto" method="POST">
        <div id="img_perfil" class="col-md-4 col-sm-12 mb-5 mt-4">
            <label for="newprodutoimg">
                <img src="../assets/imgs/logo.jpg" id="imgperfilAdd">
            </label>
            <input type="file" id="newprodutoimg" name="newprodutoimg" class="d-none">
            <button type="button" id="inputFileAdd">Escolher imagem</button>
        </div>
        <div class="inputs">
    ...
    <form enctype="multipart/form-data" action="../config/editproduto.php" id="formeditproduto" method="POST">
        <div id="img_perfil" class="col-md-4 col-sm-12">
            <label for="editprodutoimg">
                ...
                <input type="file" id="editprodutoimg" name="editprodutoimg" class="d-none">
                <button type="button" id="inputFileEdit">Escolher imagem</button>
            </label>
        </div>
        <div class="inputs">
