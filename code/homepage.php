...
<body>
    ...
    <header>
        <nav id="menu">
            ...
            <!-- icone "conta" -->
                <a href="./endereco.html"><img src="./assets/imgs/icons/conta.svg" id="icone_menu"></a>

            <!-- icone "carrinho" -->
                <a href="./assets/Estoque/Estoque.php"><img src="./assets/imgs/icons/carrinho.svg" id="icone_menu"></a>
        </nav>
    ...
    <main>
        ...
        <div id="local_fisico">
          <p id="endereco_fisico">Endereço: Rua Coronel Arruda Botelho, 291 - Centro, Boituva - SP, 18550-000</p>
          <p id="telefone_fisico">Telefone: (15) 3316-5606</p>
          <p id="horario_fisico">Horário de funcionamento: Aberto ⋅ Fecha às 19:00<img src="./assets/imgs/icons/seta_baixo_preta.svg" id="seta_menor"></p>
          
          <!-- nao consegui alinhar o icone nessa porra -->
          <!-- <div id="icon_mapa_loc">
            <img src="./assets/imgs/icons/location_map.svg" alt="icone mapa" id="img_map">
          </div>
        </div> -->
