...
<body>
    ...
    <div class="container-fluid" style="margin:0;">
        <div class="row">
            <div class="img col-md-6 col-sm-12"></div>

            <div class="col-md-6 col-sm-12" style="padding-top: 10vh;">
                <h3 class="my-5" style="padding-left: 10vw;">Cadastro de usuário</h3>
                <div class="col-10" style="padding-left: 10vw;">
                <form enctype="multipart/form-data" class="row" action="./config/insert.php" method="POST">
